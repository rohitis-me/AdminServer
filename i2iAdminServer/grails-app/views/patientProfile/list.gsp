		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${patientProfileInstanceList}" status="i" var="patientProfileInstance">
					<li>
						<g:link action="show" id="${patientProfileInstance.id}">${patientProfileInstance}</g:link>
						<g:link action="edit" id="${patientProfileInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
			<fieldset class="pagination">
				<g:paginate total="${patientProfileInstanceTotal}" />
			</fieldset>
		</div>
