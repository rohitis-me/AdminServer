			...
			<tbody>
				<tr>
					...
					<td><g:fieldValue class="label-control" bean="${orderDetails}"
							...
							<g:if test="${brandData?.strength}">${" "+brandData.strength}</g:if></td>
				</tr>
				<tr>
					<td></td>										
					<g:set var="number_units" value="${brandData?.noOfUnits?.isInteger()?brandData.noOfUnits.toFloat():null}" />
					<td><g:if test="${brandData?.noOfUnits && !brandData.noOfUnits?.contains("ml") && number_units && number_units > 1}">					
						...
						</g:if> <g:elseif test="${brandData?.noOfUnits  && brandData.noOfUnits?.contains("ml")}">
					<span class="label-control">Each unit has </span>${brandData.noOfUnits}
						</g:elseif></td>
				</tr>
				<tr>
					...
					<td><span class="label-control">${storeName}</span></td>
				</tr>
				<tr>
