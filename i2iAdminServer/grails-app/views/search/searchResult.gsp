	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-10 col-md-offset-1">
				<g:form controller="shoppingCart" action="addItemToCart"
					method="PUT">
						...
						<div class="panel panel-default order-panel">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									<label for="inputEmail3" class="col-sm-4 control-label">Quantity
										:</label>
									<div class="col-sm-7">
										<g:select class="form-control" style="width:auto;" required=""
											name="quantity" from="${1..100}" value="${quantity}"></g:select>
							...
							<div class="panel-footer clearfix">
								...
								<div class="col-xs-6 col-sm-3">
									<button type="submit" name="placeOrderNow"
