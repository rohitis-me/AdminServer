		...
		<div data-role="content">
			...
			<ul data-role="listview" data-split-icon="gear" data-filter="true">
				<g:each in="${drugInstanceList}" status="i" var="drugInstance">
					<li>
						<g:link action="show" id="${drugInstance.id}">${drugInstance}</g:link>
						<g:link action="edit" id="${drugInstance.id}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
					</li>
				</g:each>
			</ol>
