		...
		<table align="center">
			<thead>
				<tr>
					...
					<g:sortableColumn property="brandName" style="width: 20%"
					...
					<g:sortableColumn property="availabilityIndex" style="width: 10%"
				...
				<g:each in="${inventoryAvailabilityList}" status="i"
					...
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:set var="availabilityId"
								value="${availabilityInstance?.availabilityId}" />
							<g:form params='[availabilityId: availabilityId]'>
			...
			<%--			<tfoot>--%>
			<%--					<g:paginate total="${inventoryAvailabilityList.size() ?: 0}" action="showInventoryDetails" />--%>
			<%--			</tfoot>--%>
		</table>
</body>
</html>
