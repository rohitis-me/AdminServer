...
<g:elseif test="${orderDetails.orderStatus == Constants.ORDER_CANCELLED}">
...
<%--</g:if>--%>
<%--</p>--%>
<g:if test="${orderDetails.orderStatus != Constants.ORDER_CANCELLED && orderDetails.orderStatus != Constants.ORDER_REJECTED && orderDetails.orderStatus != Constants.ORDER_DELIVERED}">
